  ...
  (function($, window, undefined) {
    ...
    $.widget("mobile.dialog", $.mobile.widget, {
      ...
      _create: function() {
        ...
        // Set aria role
        $el.wrapInner(dialogWrap).children().find(":jqmData(role='header')").first().prepend(headerCloseButton).end().end().children(':first-child').addClass("ui-corner-top").end().children(":last-child").addClass("ui-corner-bottom");
      ...
      _create: function() {
        ...
        collapsible.bind("expand collapse", function(event) {
          if (!event.isDefaultPrevented()) {
            ...
            collapsibleHeading.toggleClass("ui-collapsible-heading-collapsed", isCollapse).find(".ui-collapsible-heading-status").text(isCollapse ? o.expandCueText : o.collapseCueText).end().find(".ui-icon").toggleClass("ui-icon-" + expandedIcon, !isCollapse)
            // logic or cause same icon for expanded/collapsed state would remove the ui-icon-class
            .toggleClass("ui-icon-" + collapsedIcon, (isCollapse || expandedIcon === collapsedIcon)).end().find("a").first().removeClass($.mobile.activeBtnClass);
    ...
    $.widget("mobile.listview", $.mobile.widget, {
      ...
      refresh: function(create) {
        ...
        var o = this.options,
            ...
            itemClassDict = {},
            item, itemClass, itemTheme, a, last, splittheme, counter, startCount, newStartCount, countParent, icon, imgParents, img, linkIcon;
        ...
        if (hasSubPages && parentPage.is(":jqmData(external-page='true')") && parentPage.data("page").options.domCache === false) {
          ...
          var newRemove = function(e, ui) {
            var nextPage = ui.nextPage,
                npURL, prEvent = new $.Event("pageremove");
    ...
    $.widget("mobile.button", $.mobile.widget, {
      ...
      _create: function() {
        var $el = this.element,
            ...
            type, name, inline = o.inline || $el.jqmData("inline"),
  ...
  (function($, undefined) {
    ...
    $.widget("mobile.popup", $.mobile.widget, {
        ...
        if (this._isOpen) {
          if (!this._expectResizeEvent()) {
            if (this._ui.container.hasClass("ui-popup-hidden")) {
              ...
              this._ui.container.removeClass("ui-popup-hidden").offset(this._placementCoords(this._desiredCoords(undefined, undefined, "window")));
            }
      ...
      _setOption: function(key, value) {
        ...
        exclusions = ["initSelector", "closeLinkSelector", "closeLinkEvents", "navigateEvents", "closeEvents", "history", "container"];
      ...
      _open: function(options) {
        var coords, transition, androidBlacklist = (function() {
          var w = window,
        ...
        this._createPrereqs(
        $.noop, $.noop, $.proxy(this, "_openPrereqsComplete"));
        ...
        this._ui.container.removeClass("ui-popup-hidden").offset(coords);
...
/* TODO:
      ...
      _close: function(immediate) {
        ...
        // 2. The screen opacity animation completes (screen())
        this._createPrereqs(
        $.proxy(this, "_closePrereqScreen"), $.proxy(this, "_closePrereqContainer"), $.proxy(this, "_closePrereqsDone"));
      ...
      _unenhance: function() {
        ...
        .detach().insertAfter(self._ui.placeholder).removeClass("ui-popup ui-overlay-shadow ui-corner-all");
      ...
      _bindContainerClose: function() {
        ...
        self.options.container.one(self.options.closeEvents, $.proxy(self, "_closePopup"));
      },
